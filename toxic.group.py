    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:
            ...
            try:
                ...
                # Request feedback
                bot.reply_to(message, "Please provide feedback within 5 minutes using /feedback <your feedback> to avoid being banned")
                ...
                def check_feedback_later(chat_id):
                    ...
                    if not check_feedback(user_id):
                        ban_user(user_id)
                        bot.send_message(chat_id, "You have been banned for 25 minutes for not providing feedback")
...
def handle_feedback(message):
    ...
    if len(command) > 1:
        ...
        response = "Please provide feedback. Usage: /feedback <your feedback>"
    bot.reply_to(message, response)
